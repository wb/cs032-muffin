    ...
    public class PlayerObject : GameObject
    {
        ...
        public override void move(float upDown, float leftRight, float strafeValue, Boolean jump, Boolean strafe)
        {
            ...
            if (strafe)
            {
                ...
                strafeVector = -strafeValue * 2.0f * Vector3.Transform(strafeVector, Matrix.CreateFromQuaternion(this.rotation) * Matrix.CreateFromAxisAngle(Vector3.Up, strafeAngle));

                directionVector = Vector3.Transform(new Vector3(0.0f, 0.0f, upDown * 2.0f), Matrix.CreateFromQuaternion(this.rotation));
            ...
            else
            {
                ...
                this.rotation *= rot;
                this.futureState.rotation = this.rotation;
                directionVector = Vector3.Transform(new Vector3(0.0f, 0.0f, upDown * 2.0f), Matrix.CreateFromQuaternion(this.rotation));
